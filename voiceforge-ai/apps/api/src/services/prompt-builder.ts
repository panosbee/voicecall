...
export function buildEnhancedInstructions(params: BuildEnhancedInstructionsParams): string {
  ...
  const calendarInstructions = customerLocale === 'el'
    ? [
        ...
        '- Ώρες λειτουργίας: 09:00-17:00, Δευτέρα-Παρασκευή. Slots κάθε 30 λεπτά. Μεσημεριανό διάλειμμα 12:30-14:00. Σαββατοκύριακο ΚΛΕΙΣΤΑ.',
    ...
    : [
        ...
        '- Business hours: 09:00-17:00, Monday-Friday. Slots every 30 minutes. Lunch break 12:30-14:00. Weekends CLOSED.',
